                    ...
                    <div class='row'>
                        ...
                        <div class='col-sm-9'>
                                ...
                                <div class="form-group">
                                    <?php
                                        ...
                                        <picture>
                                            ...
                                            <img src="<?= base_url('assets/img/upload/') . $b['image']; ?>" class="rounded mx-auto mb-3 d-blok" alt="..." width="70">
                                        </picture>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" onclick="window.history.back(-1)">Batal ubah</button>
